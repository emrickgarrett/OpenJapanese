...
const FALLBACK_ITEMS = [
  ...
  { id: 'f21', japanese: '水', meaning: 'water' },
  { id: 'f22', japanese: '火', meaning: 'fire' },
  { id: 'f23', japanese: '木', meaning: 'tree' },
  { id: 'f24', japanese: '花', meaning: 'flower' },
  { id: 'f25', japanese: '空', meaning: 'sky' },
];
...
export default function SpeedRoundPage() {
  ...
  if (isLoading) {
    return (
      <div className="flex h-64 items-center justify-center">
        <motion.div
          className="h-8 w-8 rounded-full border-4 border-orange-400 border-t-transparent"
          animate={{ rotate: 360 }}
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Game */}
      <SpeedRound key={gameKey} items={items} difficulty={difficulty} />
    </div>
  );
}
